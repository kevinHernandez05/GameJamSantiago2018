    ...
    public void OnSceneGUI()
    {
        ...
        if (owner.Path != null)
        {
            ...
            {                
                ...
                vPathPos += Handles.FreeMoveHandle(vWorldPathPos, Quaternion.identity, 0.15f * HandleUtility.GetHandleSize(vPathPos), Vector3.zero, Handles.SphereCap) - vWorldPathPos;
