    ...
    public class PlatformCharacterInput : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (InputMode == eInputMode.Gamepad)
            {
                ...
                m_platformCtrl.SetActionState(eControllerActions.PlatformDropDown, Input.GetButton("Jump") && (fVerAxis <= -AxisMovingThreshold));
                m_platformCtrl.SetActionState(eControllerActions.Jump, Input.GetButton("Jump") && !(fVerAxis <= -AxisMovingThreshold));
            }
