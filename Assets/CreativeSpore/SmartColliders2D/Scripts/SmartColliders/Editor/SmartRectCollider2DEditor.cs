    ...
    public class SmartRectCollider2DEditor : Editor
    {
        ...
        public void OnSceneGUI()
        {
            ...
            else
            {
                ...
                Vector3 vCenter = Handles.FreeMoveHandle(smartRect.transform.TransformPoint(smartRect.Center), Quaternion.identity, 0.05f * HandleUtility.GetHandleSize(smartRect.transform.position), Vector3.zero, Handles.DotCap);
        ...
        private void _DoBodyFreeMoveHandle(Vector3 vBody)
        {
            ...
            Vector3 vBodyHandler = Handles.FreeMoveHandle(vTransform, Quaternion.identity, 0.15f * HandleUtility.GetHandleSize(smartRect.transform.position), Vector3.zero, Handles.SphereCap) - vTransform;
        ...
        private void _DoSkinFreeMoveHandle(Vector3 vSkin, Vector3 vBody)
        {
            ...
            Vector3 vSkinHandler = Handles.FreeMoveHandle(smartRect.transform.TransformPoint(smartRect.Center + vBody + vSkin), Quaternion.identity, 0.15f * HandleUtility.GetHandleSize(smartRect.transform.position), Vector3.zero, Handles.SphereCap) - vTransform;
