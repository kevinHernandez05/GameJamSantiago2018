...
namespace CreativeSpore.SmartColliders
{
    ...
    public class PlatformCharacterControllerEditor : Editor
    {
        ...
        public void OnSceneGUI()
        {
            ...
            minJumpHeight = Vector3.Project(Handles.FreeMoveHandle(simulationBaseWorldPos + minJumpHeight * targetObj.transform.up, Quaternion.identity, 0.15f * HandleUtility.GetHandleSize(targetObj.transform.position), Vector3.zero, Handles.SphereCap) - simulationBaseWorldPos, targetObj.transform.up).magnitude;
            ...
            maxJumpHeight = Vector3.Project(Handles.FreeMoveHandle(simulationBaseWorldPos + maxJumpHeight * targetObj.transform.up, Quaternion.identity, 0.15f * HandleUtility.GetHandleSize(targetObj.transform.position), Vector3.zero, Handles.SphereCap) - simulationBaseWorldPos, targetObj.transform.up).magnitude;
            ...
            serializedObject.FindProperty("m_jumpingGuideOffset").vector3Value = Handles.FreeMoveHandle(simulationBaseWorldPos, Quaternion.identity, 0.15f * HandleUtility.GetHandleSize(targetObj.transform.position), Vector3.zero, Handles.SphereCap) - targetObj.transform.position;
